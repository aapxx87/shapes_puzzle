function makeMovable(element, figureName) {
  ...
  element.addEventListener('touchstart', (e) => {
    if (e.touches.length === 1) {
      updatePositionRotationAndSkew(); // Обновление перед началом движения
